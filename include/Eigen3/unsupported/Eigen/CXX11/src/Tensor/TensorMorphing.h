...
struct TensorEvaluator<const TensorReshapingOp<NewDimensions, ArgType>, Device>
{
    ...
    {
        return const_cast<Scalar*>(m_impl.data());
    }
...
template <typename Index, typename Device> struct MemcpyTriggerForSlicing
{
    ...
    EIGEN_DEVICE_FUNC bool operator ()(Index val) const
    {
...
struct TensorEvaluator<const TensorStridingSlicingOp<StartIndices, StopIndices, Strides, ArgType>, Device>
{
    ...
    //use by sycl
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const StartIndices& exprStartIndices() const
    {
        return m_exprStartIndices;
    }
    //use by sycl
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE  const StartIndices& exprStopIndices() const
    {
        return m_exprStopIndices;
    }
    //use by sycl
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE  const StartIndices& strides() const
    {
        return m_strides;
    }
    /// used by sycl
