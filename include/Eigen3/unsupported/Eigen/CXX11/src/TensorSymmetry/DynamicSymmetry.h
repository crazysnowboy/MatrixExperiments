...
public:
    ...
    inline DynamicSGroup(DynamicSGroup&& o) : m_numIndices(o.m_numIndices), m_elements(), m_generators(o.m_generators), m_globalFlags(o.m_globalFlags)
    {
    ...
    inline void addSymmetry(int one, int two)
    {
        add(one, two, 0);
    }
    inline void addAntiSymmetry(int one, int two)
    {
        add(one, two, NegationFlag);
    }
    inline void addHermiticity(int one, int two)
    {
        add(one, two, ConjugationFlag);
    }
    inline void addAntiHermiticity(int one, int two)
    {
