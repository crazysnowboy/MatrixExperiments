...
struct CPUContext
{
    ...
    const Eigen::DefaultDevice& device() const
    {
        return cpu_device_;
    }

    const Eigen::Tensor<float, 3>& in1() const
    {
        return in1_;
    }
    const Eigen::Tensor<float, 3>& in2() const
    {
        return in2_;
    }
    ...
    const Eigen::Tensor<float, 1>& kernel1d() const
    {
        return kernel_1d_;
    }
    const Eigen::Tensor<float, 2>& kernel2d() const
    {
        return kernel_2d_;
    }
    const Eigen::Tensor<float, 3>& kernel3d() const
    {
        return kernel_3d_;
    }
...
struct GPUContext
{
    ...
    const Eigen::GpuDevice& device() const
    {
        return gpu_device_;
    }

    const Eigen::TensorMap<Eigen::Tensor<float, 3> >& in1() const
    {
        return in1_;
    }
    const Eigen::TensorMap<Eigen::Tensor<float, 3> >& in2() const
    {
        return in2_;
    }
