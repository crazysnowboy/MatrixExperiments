...
{
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[0][0]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[0][1]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[0][2]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[1][0]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[1][1]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[1][2]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[2][0]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[2][1]);
    i_row += 1;
    __dt_CHOLMOD_MODIFYVEC(C, i_row, T[2][2]);
    i_row += 1;
